...
const Onboarding = () => {
  ...
  const fetchQuestions = async () => {
    try {
      const response = await axios.get('http://localhost:8000/api/admin/onboarding/questions');
  ...
  const handleDelete = (id) => {
	  confirmDelete(`http://localhost:8000/api/admin/delete/OnboardingQuestion/${id}`, fetchQuestions);
	};
