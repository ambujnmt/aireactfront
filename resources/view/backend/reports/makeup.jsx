...
import { fetchMakeupReport } from "../../../../src/utils/fetchAdminApi";
...
const ProductReport = () => {
  ...
  const loadReports = async () => {
    setLoading(true);
    try {
      const res = await fetchMakeupReport();
    ...
    <div className="container-fluid py-4">
      <div className="card shadow-lg border-0 rounded-2 p-4">
        <div className="d-flex justify-content-between align-items-center mb-3">
          <div>
            <h2 className="fw-bold mb-1">Makeup Usage Report</h2>
            <p className="text-muted mb-0">Unique device usage per makeup</p>
          </div>
        </div>
